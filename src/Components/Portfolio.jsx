...
// const Portfolio = () => {
//   return (
//     <div className="w-full h-auto flex flex-col text-center pt-5 md:pt-14 lg:pt-20  mb-16">
//       <div>
//         <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold">
//           Our portfolio
//         </h1>
//         {/*   pt-4 md:pt-5  */}
//         <p className=" p-5 md:p-6  px-6 md:px-64 lg:px-96">
//           Lorem ipsum dolor{" "}
...
//         className="flex flex-col md:mt-5 gap-12 md:flex-row md:flex-wrap items-center text-center justify-center lg:flex-row-2 "
//       >
//         {/* card first-------------- */}
//         <div className="py-2">
...
//         <div className=" w-full md:w-1/4 rounded p-3 bg-gradient-to-r from-[#53ADE4] to-[#277BA8] opacity-100 ">
